...
Preview The App Page
    ...
    Unselect Frame
    Select Frame    ${app_iframe_parent_selector}
    Wait Until Element Is Visible   ${studio_vrbank_header_preview_button}
    Click Element   ${studio_vrbank_header_preview_button}
    Select Frame    ${app_iframe_sub_parent_selector}
...
Exit Preview The App Page
    ...
    Unselect Frame
    Select Frame    ${app_iframe_parent_selector}
    Wait Until Element Is Visible   ${studio_vrbank_header_exit_preview_button}
    Click Element   ${studio_vrbank_header_exit_preview_button}
    Select Frame    ${app_iframe_sub_parent_selector}
